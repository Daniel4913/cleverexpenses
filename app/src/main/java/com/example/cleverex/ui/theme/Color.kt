...
val md_theme_light_primaryContainer = Color(0xFF8DF2FF)
...
val md_theme_dark_onPrimaryContainer = Color(0xFF8DF2FF)
val md_theme_dark_secondary = Color(0xFFDFC64C)
